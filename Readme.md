...
[![GitHub repo stars](https://img.shields.io/github/stars/ossappscollective/OSS-DocumentScanner?style=flat)](https://github.com/ossappscollective/OSS-DocumentScanner/stargazers)
[![GitHub License](https://img.shields.io/github/license/ossappscollective/OSS-DocumentScanner)](https://github.com/ossappscollective/OSS-DocumentScanner/blob/master/COPYING)
[![GitHub All Releases](https://img.shields.io/github/downloads/ossappscollective/OSS-DocumentScanner/total.svg)](https://github.com/ossappscollective/OSS-DocumentScanner/releases/)
[![GitHub release](https://img.shields.io/github/v/release/ossappscollective/OSS-DocumentScanner?display_name=release&filter=*scanner*)](https://github.com/ossappscollective/OSS-DocumentScanner/releases)
[![GitHub release](https://img.shields.io/github/v/release/ossappscollective/OSS-DocumentScanner?display_name=release&filter=*wallet*)](https://github.com/ossappscollective/OSS-DocumentScanner/releases)
...
|[<img src="graphics/badge_github.png" alt="Get it on GitHub" height="50">](https://github.com/ossappscollective/OSS-DocumentScanner/releases)|[<img src="graphics/badge_github.png" alt="Get it on GitHub" height="50">](https://github.com/ossappscollective/OSS-DocumentScanner/releases)|
...
You can,
- [Create an issue here](https://github.com/ossappscollective/OSS-DocumentScanner/issues)
...
* download from [here](https://github.com/ossappscollective/OSS-DocumentScanner/releases/tag/dev_resources) and uncompress them at the root
* build them yourself:
